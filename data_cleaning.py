...
def drop_columns (df):
    df = df[['year', 'locationabbr', 'locationdesc', 'topicdesc', 'measuredesc','age', 'gender', 'race', 'education', 'response', 'sample_size', 'data_value', 'data_value_std_err', 'low_confidence_limit', 'high_confidence_limit']]
    pass
